...
namespace Ifc
{
    public class IfcRelContainedInSpatialStructure : IfcRelConnects, IEquatable<IfcRelContainedInSpatialStructure>
    {
        ...
        public IfcRelContainedInSpatialStructure(IfcId id, IfcId ownerHistoryId, string name, string description, List<IfcId> relatedElementIds, IfcId relatingStructureId) : base(id, ownerHistoryId, name, description)
        {
            RelatedElementIds = relatedElementIds;
            RelatingStructureId = relatingStructureId;
        }

        public override ClassId GetClassId() => ClassId.IfcRelContainedInSpatialStructure;
        ...
        public override bool Equals(object other) => Equals(other as IfcRelContainedInSpatialStructure);

        public static bool operator ==(IfcRelContainedInSpatialStructure one, IfcRelContainedInSpatialStructure other)
        {
        ...
        public static bool operator !=(IfcRelContainedInSpatialStructure one, IfcRelContainedInSpatialStructure other) => !(one == other);
        ...
        {
            return new IfcRelContainedInSpatialStructure (newId,OwnerHistoryId, Name, Description, RelatedElementIds, RelatingStructureId);
        }
        ...
        public override JObject ToJson()
        {
            ...
            {
                { "id", (string)Id },
                { "class_id", (int)ClassId.IfcRelContainedInSpatialStructure },
                { "class", nameof(IfcRelContainedInSpatialStructure) },
        ...
        public static IfcRelContainedInSpatialStructure CreateFromJson(JObject jObject)
        {
